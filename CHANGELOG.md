...
- fix: `slide-landmarks` keeps every slide available to assistive technology in the print view and the scroll view, and keeps every slide clickable in the overview. (#25)
