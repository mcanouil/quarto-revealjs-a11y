...
User preferences (high contrast, font size, font family, text spacing, link highlight) are saved to `localStorage` and persist across sessions and page reloads.
